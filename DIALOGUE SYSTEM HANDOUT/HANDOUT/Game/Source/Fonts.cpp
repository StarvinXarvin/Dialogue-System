...
FontManager::FontManager() : Module()
{
	name.Create("fonts");
}
...
int FontManager::Load(const char* texture_path, const char* characters, uint rows)
{
	int id = -1;
...
void FontManager::UnLoad(int font_id)
{
...
void FontManager::BlitText(int x, int y, int font_id, const char* text, bool useCamera) const
{
